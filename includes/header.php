    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <!--                     <div class="d-inline-flex align-items-center me-4">
                                    <select id='select_lang' onchange='change_lang(this.value)'  data-show-content='true' class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" style="font-size:10px">
        ...
        <div class="btn-group btn-group-toggle me-4 " data-toggle="buttons">
            <label class="btn btn-primary ">
                <input type="radio" name="options" onchange='change_lang(this.value)' value="th" id='select_lang' style="visibility:hidden; " autocomplete="off">TH
            </label>
            <label class="btn btn-primary active ">
                <input type="radio" name="options" onchange='change_lang(this.value)' value="en" id='select_lang' style="visibility:hidden;" autocomplete="off"> EN
            </label>
        </div>
