...
<div class="container-xxl py-5">
    ...
    <div class="row">
        ...
        ?>
                <div class="col-lg-6 col-md-6 d-flex align-items-stretch portfolio-item wow fadeInUp mb-3 project" 
                    ...
                    <div class="card border-0 rounded overflow-hidden flex-grow-1">
                        ...
                        <!-- เนื้อหา -->
                        <div class="card-body border border-5 border-light border-top-0 p-4 content_project" style="display:none;" >
