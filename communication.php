        ...
        <div class="row g-5">
            <div class="col-lg-6">
                <div class="row gx-3 h-100">
                    <?php
                    $query = "SELECT * FROM tbl_posts INNER JOIN tbl_categories ON tbl_categories.cat_id = tbl_posts.post_category_id  WHERE tbl_categories.cat_page=9 AND tbl_posts.post_status='Published'";
...
<div class="container-xxl py-5">
    ...
    <?php
        $query_product = "SELECT * FROM tbl_posts 
                           ...
                           WHERE tbl_categories.cat_page=10 AND tbl_posts.post_status='Published'";
